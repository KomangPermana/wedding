				...
				<div class="collapse navbar-collapse text-center" id="navigation">
					<ul class="navbar-nav ml-auto">
						<li class="nav-item active">
							<a class="nav-link" href="contact.html">Blog</a></a>
						</li>
					</ul>
				</div>
			</nav>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 heading">
					...
					<h2 class="title">Kelebihan Yang Kami Tawarkan <span class="title-desc">Ribuan pelanggan telah percaya dengan kami</span></h2>
				</div>
			</div><!-- Title row end -->
			...
			<div class="row">
				<div class="col-md-3 col-sm-3 wow fadeInDown text-center" data-wow-delay=".5s">
					<div class="service-content text-center">
						...
						<h3>Unik</h3>
						<p>Undangan eksklusif yang simpel & elegan</p>
					</div>
				</div>
				<!--/ End first service -->
				...
				<div class="col-md-3 col-sm-3 wow fadeInDown text-center" data-wow-delay=".8s">
					<div class="service-content text-center">
						...
						<h3>Ringan</h3>
						<p>Undangan Digital yang ringan untuk diakses</p>
					</div>
				</div>
				<!--/ End Second service -->
				...
				<div class="col-md-3 col-sm-3 wow fadeInDown text-center" data-wow-delay="1.4s">
					<div class="service-content text-center">
						...
						<h3>Cepat</h3>
						<p>Proses pembuatan yang cepat dan tepat waktu</p>
					</div>
				</div>
				<!--/ End 4th service -->
			</div><!-- Content row end -->
	    ...
	    <div class="row">
	      <div class="col-md-12 text-center">
	        <ul class="footer-social unstyled">
	          <li>
	            <a title="Facebook" href="https://www.facebook.com/nikahankami/">
	              <span class="icon-pentagon wow bounceIn"><i class="fa fa-facebook"></i></span>
	            </a>
	            <a title="Instagram" href="https://www.instagram.com/nikahankami/">
